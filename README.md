...
相较于其他华丽的魔法，咒法更可以被称之为自然的艺术。咒法与艺术都表达于感性，凝结于概念，最终实现于语言。咒法是运用媒质的技艺：将概念以符合逻辑的方式表述为咒术，以使得产生于意识的媒质作用于自然；概念承载于媒介以特定方式绘成的图案，而逻辑又由整体的目的与图案的限制共同界定。

这是手册开端对于咒术的概念。

阿卡夏图书馆是属于他们的自然，永恒之书是由我定义的我。
...
这是一场构建于纯粹概念中的思维实验，遵循旧版Minecraft的极简风格，引入围绕咒法学的形而上学暗线。你将在晦涩的残篇中辨识逻辑，在逻辑的咒法中认出自然，最终发现一切的真理不是别的，而只是你发展着的认识而已。
...
1. 所有剧情与指引，均写于世界生成时自带的咒术手册中。

2. 整合包以咒法学为核心，世界观自行构建。通过深度魔改，将所有模组与机制整合到叙事之中。

3. 整合包的定位是基础包，可单开，也可加入其他诸多非咒法模组，否则需要参考下文的魔改指北进行兼容。考虑到这一点，未添加任何不必要的优化。
...
我执用以创建属于我的图案，唯识用以读取真名中的信息。阿卡夏图书馆是属于他们的自然，永恒之书是由我定义的我。
